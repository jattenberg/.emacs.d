...
(defun color-theme-sunburst ()
  ...
  (color-theme-install
   '(color-theme-sunburst
     ...
     (vertical-border ((t (:background "#111" :foreground "#efefef"))))
     (mode-line ((t (:background "#333" :foreground "#efefef"))))
     (mode-line-inactive ((t (:background "#111" :foreground "#efefef"))))
     (horizontal-border ((t (:background "#111" :foreground "#efefef"))))
